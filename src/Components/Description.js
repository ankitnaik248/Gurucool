...
import { StyleSheet, Text, View, Image, TextInput, Dimensions, ImageBackground, Alert, TouchableOpacity, ScrollView } from 'react-native';
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{width: width, height:"30%", top: 0, bottom: 0, left: 0, right: 0,  backgroundColor: "black" }} >
                    <ImageBackground source = { require("../Images/DescriptionPageBannerUpper.jpg") } style = {[styles.backgroundImage,{justifyContent:"center"}]}></ImageBackground>
                </View>
                <View style = {{ backgroundColor: "pink",height:"70%",width: width}}>
                    <ImageBackground source = { require("../Images/sub_desc_bg.jpg") } style = {{justifyContent:"center", width: width, height: "100%"}}>
                        <Text style = {styles.headerPara}>Transformers Prime Predacons Rising (E)</Text>
