  ...
  render () {
      return (
        <View style={styles.container}> 
          <Image source = { require("../Images/Background.jpg") } style = {styles.backgroundImage}></Image>
          <TextInput 
            style = {styles.text}
          ...
          <View style = { styles.textPara }>
            <Text style = { styles.button } onPress = { () => { this.props.navigation.navigate("Subscription") }} >GET OTP</Text>
          </View>
